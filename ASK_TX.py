...
class ASK_TX(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "ASK_TX", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("ASK_TX")
        ...
        self.settings = Qt.QSettings("GNU Radio", "ASK_TX")
        ...
        self.tx_Frequency = tx_Frequency = 915013200
        self.sps = sps = 100
        ...
        self._tx_Frequency_range = Range(915009000, 915020000, 1, 915013200, 200)
        self._tx_Frequency_win = RangeWidget(self._tx_Frequency_range, self.set_tx_Frequency, 'TX Frequecny', "counter_slider", float, QtCore.Qt.Horizontal)
        self.top_layout.addWidget(self._tx_Frequency_win)
        self.qtgui_time_sink_x_0 = qtgui.time_sink_c(
            1024*8, #size
            samp_rate, #samp_rate
            "MESSAGE SIGNAL TIME SINK", #name
            1, #number of inputs
            None # parent
        )
        ...
        self.qtgui_freq_sink_x_0 = qtgui.freq_sink_c(
            ...
            0, #fc
            samp_rate, #bw
            "MESSAGE SIGNAL FREQUENCY SINK", #name
            1,
            None # parent
        )
        ...
        self.blocks_vector_source_x_0 = blocks.vector_source_c([0, 1/3, 2/3, 1], True, 1, [])
