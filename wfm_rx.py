...
class wfm_rx(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "wfm_rx")
        ...
        # Blocks
        ##################################################
        self._tune_range = Range(400000000, 400100000, 10, 400000010, 200)
        ...
        self._rx_gain_range = Range(10, 70, 1, 40, 200)
        ...
        self.rtlsdr_source_0.set_center_freq(tune, 0)
        ...
        labels = ['Audio', 'Signal 2', 'Signal 3', 'Signal 4', 'Signal 5',
        ...
        self.analog_wfm_rcv_0 = analog.wfm_rcv(
        	...
        	audio_decimation=int(samp_rate/LPF_decimation/48e3),
        )
        ...
        self.connect((self.analog_wfm_rcv_0, 0), (self.qtgui_time_sink_x_2, 0))
    ...
    def set_tune(self, tune):
        self.tune = tune
        self.qtgui_freq_sink_x_0.set_frequency_range(self.tune, self.samp_rate)
        self.rtlsdr_source_0.set_center_freq(self.tune, 0)
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.low_pass_filter_1.set_taps(firdes.low_pass(1, self.samp_rate, 100e3, 50e3, window.WIN_HAMMING, 6.76))
        self.qtgui_freq_sink_x_0.set_frequency_range(self.tune, self.samp_rate)
        self.qtgui_freq_sink_x_0_0.set_frequency_range(0, self.samp_rate/self.LPF_decimation)
